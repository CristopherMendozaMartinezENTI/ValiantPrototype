...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USteamAudioOcclusionSettingsFactory_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_USteamAudioOcclusionSettingsFactory_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_Work_UnrealEngineProjects_ValiantPrototype_Plugins_steamaudio_unreal_unreal_SteamAudio_Source_SteamAudioEditor_Private_SteamAudioOcclusionSettingsFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_UnrealEngineProjects_ValiantPrototype_Plugins_steamaudio_unreal_unreal_SteamAudio_Source_SteamAudioEditor_Private_SteamAudioOcclusionSettingsFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USteamAudioOcclusionSettingsFactory, USteamAudioOcclusionSettingsFactory::StaticClass, TEXT("USteamAudioOcclusionSettingsFactory"), &Z_Registration_Info_UClass_USteamAudioOcclusionSettingsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamAudioOcclusionSettingsFactory), 2206131369U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_UnrealEngineProjects_ValiantPrototype_Plugins_steamaudio_unreal_unreal_SteamAudio_Source_SteamAudioEditor_Private_SteamAudioOcclusionSettingsFactory_h_3144506669(TEXT("/Script/SteamAudioEditor"),
		Z_CompiledInDeferFile_FID_Work_UnrealEngineProjects_ValiantPrototype_Plugins_steamaudio_unreal_unreal_SteamAudio_Source_SteamAudioEditor_Private_SteamAudioOcclusionSettingsFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_UnrealEngineProjects_ValiantPrototype_Plugins_steamaudio_unreal_unreal_SteamAudio_Source_SteamAudioEditor_Private_SteamAudioOcclusionSettingsFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
